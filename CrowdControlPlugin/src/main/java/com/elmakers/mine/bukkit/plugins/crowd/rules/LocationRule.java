...
public class LocationRule implements Rule {
	...
	public LocationRule(long[] xyzA, long[] xyzB, Set<World> worlds, CreatureType type){
	...
	public LocationRule(Vector point1, Vector point2, Set<World> worlds, CreatureType type){
